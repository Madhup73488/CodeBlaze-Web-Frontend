    ...
    <div className={`internship-card ${theme}`}>
      ...
      <div className="skills-tags">
        {internship.skills && internship.skills.slice(0, 3).map((skill, index) => (
          <span key={index} className="skill-tag" style={{ backgroundColor: `${primaryColor}20`, color: primaryColor }}>
            {skill}
          </span>
        ))}
        {internship.skills && internship.skills.length > 3 && (
          <span className="skill-tag" style={{ backgroundColor: `${primaryColor}20`, color: primaryColor }}>
