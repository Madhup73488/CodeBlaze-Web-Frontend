...
import { fetchInternshipApplications } from '../../utils/api';
...
const InternshipApplications = () => {
  ...
  useEffect(() => {
    const loadApplications = async () => {
      try {
        setLoading(true);
        const data = await fetchInternshipApplications(filters);
  ...
  const columns = [
    ...
    { id: 'applicantName', header: 'Student Name', accessor: 'applicantName' },
    { id: 'university', header: 'University', accessor: 'university' },
    { id: 'program', header: 'Internship Program', accessor: 'program' },
  ...
  const handleStatusChange = async (id, newStatus) => {
    ...
    console.log('Update status for internship application:', id, 'to', newStatus);
  };
